...
?>
  ...
  <table>
	<?php if (isset($content['field_student_s_name']['#title'])) { ?>
	...
	<?php if (isset($content['field_class']['#title'])) { ?>    
	    <tr><td class="st"><span class="st_"><?php  print render($content['field_class']['#title']); ?>: </span><?php  print render($content['field_class'][0]['#markup']); ?>
	...
	<?php if (isset($content['field_term']['#title'])) { ?>    
	    <tr><td class="st"><span class="st_"><?php  print render($content['field_term']['#title']); ?>: </span><?php  print render($content['field_term'][0]['#markup']); ?></td></tr>
    <?php } ?> 

	<?php if (isset($content['field_session']['#title'])) { ?>    
    	<tr><td class="st"><span class="st_"><?php  print render($content['field_session']['#title']); ?>: </span><?php  print render($content['field_session'][0]['#markup']); ?></td></tr>
    <?php } ?> 
 
	<?php if (isset($content['field_average_score']['#title'])) { ?>    
    	<tr><td class="st"><span class="st_"><?php  print render($content['field_average_score']['#title']); ?>: </span><?php  print render($content['field_average_score'][0]['#markup']); ?></td></tr>
    <?php } ?> 
    
	<?php if (isset($content['field_average_score2']['#title'])) { ?>    
    	<tr><td class="st"><span class="st_"><?php  print render($content['field_average_score2']['#title']); ?>: </span><?php  print render($content['field_average_score2'][0]['#markup']); ?></td></tr>
    <?php } ?> 

	<?php if (isset($content['field_position']['#title'])) { ?>    
    	<tr><td class="st"><span class="st_"><?php  print render($content['field_position']['#title']); ?>: </span><?php  print render($content['field_position'][0]['#markup']); ?></td></tr>
    <?php } ?> 
    
   
	<tr><td class="st">
	<?php if (isset($content['field_class_average_minimum']['#title'])) { ?>    
    	<span class="st_"><?php  print render($content['field_class_average_minimum']['#title']); ?>:</span> <?php  print render($content['field_class_average_minimum'][0]['#markup']); ?>
    <?php echo "|"; } ?> 
    
	<?php if (isset($content['field_class_average_maximum']['#title'])) { ?>    
    	<span class="st_"><?php  print render($content['field_class_average_maximum']['#title']); ?>:</span> <?php  print render($content['field_class_average_maximum'][0]['#markup']); ?>
    <?php echo "|"; } ?> 
   
	<?php if (isset($content['field_class_average_average']['#title'])) { ?>        
    	<span class="st_"><?php  print render($content['field_class_average_average']['#title']); ?>:</span> <?php  print render($content['field_class_average_average'][0]['#markup']); ?>
    <?php } ?> 
    </td></tr>
  </table>
<br>
  <table>
   <?php if (isset($node->field_header['und'][0]['value'])) { ?>
    ...
    <tr class="t1">
    	...
    	<?php $header_id = $node->field_header['und'][0]['value']; ?>
        <td class="s1 st_"><?php  print render($content['field_header'][0]['entity']['field_collection_item'][$header_id]['field_header_ca_score']['#items'][0]['value']); ?></td>
        <td class="s1 st_"><?php  print render($content['field_header'][0]['entity']['field_collection_item'][$header_id]['field_header_exam_score']['#items'][0]['value']); ?></td>
        <td class="s1 st_"><?php  print render($content['field_header'][0]['entity']['field_collection_item'][$header_id]['field_header_total_score']['#items'][0]['value']); ?></td>

        <td class="s1 st_"><?php  print render($content['field_header'][0]['entity']['field_collection_item'][$header_id]['field_header_total_score']['#items'][0]['value']); ?></td>
        <td class="s1 st_"><?php  print render($content['field_header'][0]['entity']['field_collection_item'][$header_id]['field_header_previous_score']['#items'][0]['value']); ?></td>
        <td class="s1 st_"><?php  print render($content['field_header'][0]['entity']['field_collection_item'][$header_id]['field_header_stanine_grade']['#items'][0]['value']); ?></td>

        <td class="s1 st_"><?php  print render($content['field_header'][0]['entity']['field_collection_item'][$header_id]['field_header_average']['#items'][0]['value']); ?></td>
        <td class="s1 st_"><?php  print render($content['field_header'][0]['entity']['field_collection_item'][$header_id]['field_header_remark']['#items'][0]['value']); ?></td>
        <td class="s1 st_"><?php  print render($content['field_header'][0]['entity']['field_collection_item'][$header_id]['field_header_teacher_s_initial']['#items'][0]['value']); ?></td>
